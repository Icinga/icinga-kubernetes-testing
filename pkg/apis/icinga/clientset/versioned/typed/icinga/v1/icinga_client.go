...
// IcingaV1Client is used to interact with features provided by the icinga.com group.
type IcingaV1Client struct {
	restClient rest.Interface
}

func (c *IcingaV1Client) Tests(namespace string) TestInterface {
...
// NewForConfigAndClient creates a new IcingaV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*IcingaV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &IcingaV1Client{client}, nil
}

// NewForConfigOrDie creates a new IcingaV1Client for the given config and
...
func New(c rest.Interface) *IcingaV1Client {
	return &IcingaV1Client{c}
}
