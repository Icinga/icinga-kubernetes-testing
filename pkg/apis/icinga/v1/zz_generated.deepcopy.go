...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestTest) DeepCopyInto(out *TestTest) {
	*out = *in
	if in.GoodReplicas != nil {
		in, out := &in.GoodReplicas, &out.GoodReplicas
		*out = new(int32)
		**out = **in
	}
	if in.BadReplicas != nil {
		in, out := &in.BadReplicas, &out.BadReplicas
		*out = new(int32)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestTest.
func (in *TestTest) DeepCopy() *TestTest {
	if in == nil {
		return nil
	}
	out := new(TestTest)
